 ...
 * 网络请求
 */
export default function _request(option: IOptions, callback?: ICallback): XMLHttpRequest {
    // 请求类型
 ...
 * 网络请求
 */
export function request(option: IOptions) {
    return new Promise((resolve) => {
        _request(option, (error, response, request) => {
